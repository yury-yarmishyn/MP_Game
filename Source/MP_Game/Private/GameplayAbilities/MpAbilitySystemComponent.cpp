...
namespace MpAbilitySystemComponent_Impl
{
...
void UMpAbilitySystemComponent::SetInputBinding(UInputAction* InputAction, FGameplayAbilitySpecHandle AbilityHandle)
{
	using namespace MpAbilitySystemComponent_Impl;
...
void UMpAbilitySystemComponent::ClearInputBinding(FGameplayAbilitySpecHandle AbilityHandle)
{
	using namespace MpAbilitySystemComponent_Impl;
...
void UMpAbilitySystemComponent::ClearAbilityBindings(UInputAction* InputAction)
{
	RemoveEntry(InputAction);
}

void UMpAbilitySystemComponent::OnAbilityInputPressed(UInputAction* InputAction)
{
	using namespace MpAbilitySystemComponent_Impl;
...
void UMpAbilitySystemComponent::OnAbilityInputReleased(UInputAction* InputAction)
{
	using namespace MpAbilitySystemComponent_Impl;
...
void UMpAbilitySystemComponent::RemoveEntry(UInputAction* InputAction)
{
...
FGameplayAbilitySpec* UMpAbilitySystemComponent::FindAbilitySpec(FGameplayAbilitySpecHandle Handle)
{
...
void UMpAbilitySystemComponent::TryBindAbilityInput(UInputAction* InputAction, FAbilityInputBinding& AbilityInputBinding)
{
	if (InputComponent)
	{
		// Pressed event
		...
		{
			AbilityInputBinding.OnPressedHandle = InputComponent->BindAction(InputAction, ETriggerEvent::Started, this, &UMpAbilitySystemComponent::OnAbilityInputPressed, InputAction).GetHandle();
		}

		// Released event
		if (AbilityInputBinding.OnReleasedHandle == 0)
		{
			AbilityInputBinding.OnReleasedHandle = InputComponent->BindAction(InputAction, ETriggerEvent::Completed, this, &UMpAbilitySystemComponent::OnAbilityInputReleased, InputAction).GetHandle();
		}
	}
}
